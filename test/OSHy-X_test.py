...
def test_run_JLF2_bimodal(mocker):
    ...
    mocker.patch('OSHyX.subprocess.Popen', return_value="A Popen object")
    mocker.patch('OSHyX.subprocess.Popen.wait', return_value=None)
    mocker.patch('OSHyX.subprocess.Popen.communicate', return_value=('Info', 'Errors'))
